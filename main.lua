...
-- the "Class" library we're using will alow us to represent anthing in
-- our game as code, rather keeping track of many disparate variables and
-- methods
--
...
-- our Ball classs, which isn't much different than a Paddle structure-wise
...
function love.load()
    ...
    -- set up our sound effent; later, we can just index this table and
...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        if ball.x < 0 then
            ...
            -- state to done so we can show the victory
            if player2Score == 10 then
                winningPlayer = 2
                gameState = 'done'
            else 
                gameState = 'serve'
                -- places the ball in the middle, no velocity
                ball:reset()
            end
        end 
    ...
    -- update our ball based on ots DX and DY only if we're in play state;
...
function love.keypressed(key)
    ...
    elseif key == 'enter' or key == 'return' then
        ...
        elseif gameState == 'done' then
            ...
            -- deside serving player as the opposite of who won
...
function displayScore()
    ...
    -- need to switch font to draw before actually pringting
